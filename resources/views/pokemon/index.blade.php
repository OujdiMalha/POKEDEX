...
<x-guest-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-8">
        <div class="bg-gray-800 p-6 rounded-lg shadow-lg">
            <h1 class="text-3xl font-bold text-yellow-500 mb-4">Liste des Pokemon</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-gray-900 rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('pokemon.show', $poke->id) }}" class="text-blue-500 hover:text-blue-700 font-semibold">En savoir plus</a>
                        </div>
                    </div>
                </div>
                @endforeach
